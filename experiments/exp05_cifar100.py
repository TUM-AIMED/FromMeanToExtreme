"""Experiment 05: CIFAR-100 at standard resolution.

Addresses AE point 4: additional standard benchmark.
Same N=3072 as CIFAR-10, but 100 classes — tests if class diversity matters.
"""
import sys
...
OUTPUT_DIR = Path(__file__).parent.parent / "results" / "exp05"
...
CONFIGS = [
    {"name": "cifar100_optimal", "arch": None, "desc": "CIFAR-100 32x32 RGB — Optimal"},
    {"name": "cifar100_resnet101", "arch": "resnet101", "desc": "CIFAR-100 32x32 RGB — ResNet-101"},
]
...
def main():
    ...
    print("=" * 60)
    print("Experiment 05: CIFAR-100")
    print(f"Device: {DEVICE}, Samples: {NUM_SAMPLES}")
    print("=" * 60)

    data = load_dataset("cifar100", resolution=None, num_samples=NUM_SAMPLES, enforced_norm=1.01, flatten=True, grayscale=False)
