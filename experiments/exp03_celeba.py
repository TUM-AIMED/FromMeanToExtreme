"""Experiment 03: CelebA at 64x64 and 128x128 resolutions.

Addresses AE point 4: realistic face dataset at different resolutions.
64x64 → N=12288 (RGB), 128x128 → N=49152 (RGB).
"""
import sys
...
OUTPUT_DIR = Path(__file__).parent.parent / "results" / "exp03"
...
CONFIGS = [
    {"name": "celeba_64_optimal", "res": 64, "arch": None, "desc": "CelebA 64x64 RGB — Optimal"},
    {"name": "celeba_64_resnet101", "res": 64, "arch": "resnet101", "desc": "CelebA 64x64 RGB — ResNet-101"},
    {"name": "celeba_128_optimal", "res": 128, "arch": None, "desc": "CelebA 128x128 RGB — Optimal"},
]
...
def main():
    ...
    for cfg in CONFIGS:
        ...
        data = load_dataset("celeba", resolution=res, num_samples=NUM_SAMPLES, enforced_norm=1.01, flatten=True, grayscale=False)
